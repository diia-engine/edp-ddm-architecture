...
### id.gov.ua ###
export ID_GOV_UA_CLIENT_ID=""
export ID_GOV_UA_CLIENT_SECRET=""
----
...
[source,shellscript]
----
sudo docker run --rm --name control-plane-installer-<version> --user root:$(id -g) --net host -v $(pwd):/tmp/installer --env KUBECONFIG=/tmp/installer/kubeconfig --env ID_GOV_UA_CLIENT_ID=mock --env ID_GOV_UA_CLIENT_SECRET=mock --env PLATFORM_DEPLOYMENT_MODE=development --env PLATFORM_LANGUAGE=uk --env PLATFORM_REGION=ua --entrypoint "/bin/bash" control-plane-installer:<version> -c "./install.sh -i"
----
+
* де `PLATFORM_DEPLOYMENT_MODE` може бути `development` чи `production`.
* де `PLATFORM_LANGUAGE` може бути `uk` чи `en`.
* де `PLATFORM_REGION` може бути `ua` чи `global`.
...
[source,shellscript]
----
sudo docker run --rm --name control-plane-installer-<version> --user root:$(id -g) --net host -v $(pwd):/tmp/installer --env KUBECONFIG=/tmp/installer/kubeconfig --env ID_GOV_UA_CLIENT_ID=mock --env ID_GOV_UA_CLIENT_SECRET=mock --entrypoint "/bin/bash" control-plane-installer:<version> -c "./install.sh -u"
----
