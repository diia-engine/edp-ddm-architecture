...
Високорівнева структурна діаграма нижче представляє ключові технології та їх застосування в реалізації функціональних та нефункціональних вимог _Платформою Реєстрів_.
